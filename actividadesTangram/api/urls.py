...
from .views import ActivarActividad, ActividadCrearVista, ActividadEliminarVista, ActividadListarVista, AsignarSalonActividad  # Importa la vista para crear actividad
